 ...
 * Su principal función es dormir durante un intervalo y luego notificar 
 * que ha ocurrido un nuevo ciclo, lo que permite actualizar métricas y la interfaz
 * de usuario en intervalos regulares.
*/
