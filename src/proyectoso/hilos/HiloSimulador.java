...
/*
 * Hilo principal de la simulación.
 * Este hilo se encarga de impulsar el avance de la simulación ciclo por ciclo. 
 * En cada ciclo, coordina la ejecución de un proceso, la lógica de planificación 
 * (incluyendo el manejo del Quantum para Round Robin), la detección de terminación 
 * o interrupciones de I/O, y la actualización de la interfaz gráfica a través del controlador.
*/
